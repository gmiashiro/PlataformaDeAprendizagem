...
var myGames = [
    "<div class='gameCard'><div class='banner'><img src='./assets/banners/lettersBanner.png'></div><div class='gameCard-content-container'><div class='gameCard-content'><div class='gameCard-tags-container'><div class='gameCard-tag poderes'><span>Poderes</span></div><span>Ensino Médio</span></div><div class='gameCard-text'><h6>Oração Subordinada Substantiva</h6><p>Revisão para a prova de lingua portuguêsa</p><span>Por: Você</span></div><div class='gameCard-info-container'><div><img src='./assets/icons/gameCard/playPurpleIcon.svg' alt='Icone de play'><span>321</span></div><div><button><img src='./assets/icons/gameCard/saveLineIcon.svg' alt='Icone de salvar'></button><span>321</span></div></div><div class='gameCard-action-buttons'><a href='./gameStart.html'><button class='gameCard-play fullColorLP myGames'>Jogar agora</button> </a><button class='gradientBorderLP'><img src='./assets/icons/gameCard/editarAzul.svg'></button></div></div>",
    ...
    "<div class='gameCard'><div class='banner'><img src='./assets/banners/mapaBanner.png'></div><div class='gameCard-content-container'><div class='gameCard-content'><div class='gameCard-tags-container'><div class='gameCard-tag detetive'><span>Detetive</span></div><span>13-14 anos</span></div><div class='gameCard-text'><h6>Paises</h6><p>Tentando adivinhar países por pistas geológicas</p><span>Por: Você</span></div><div class='gameCard-info-container'><div><img src='./assets/icons/gameCard/playPurpleIcon.svg' alt='Icone de play'><span>321</span></div><div><button><img src='./assets/icons/gameCard/saveLineIcon.svg' alt='Icone de salvar'></button><span>321</span></div></div><div class='gameCard-action-buttons'><a href='./gameStart.html'><button class='gameCard-play fullColorLP myGames'>Jogar agora</button> </a><button class='gradientBorderLP'><img src='./assets/icons/gameCard/editarAzul.svg'></button></div></div>"
];

var savedGames = [
    "<div class='gameCard'><div class='banner'><img src='./assets/banners/pigBanner.png'></div><div class='gameCard-content-container'><div class='gameCard-content'><div class='gameCard-tags-container'><div class='gameCard-tag gincana'><span>Gincana</span></div><span>3-5 anos</span></div><div class='gameCard-text'><h6>Três porquinhos</h6><p>Competição sobre os Três porquinhos</p><span>Por: Joana Silva</span></div><div class='gameCard-info-container'><div><img src='./assets/icons/gameCard/playPurpleIcon.svg' alt='Icone de play'><span>321</span></div><div><button onclick='add()'><img src='./assets/icons/gameCard/saveLineIcon.svg' alt='Icone de salvar'></button><span>321</span></div></div><div><a href='./gameStart.html'><button class='gameCard-play fullColorLP'>Jogar agora</button></a></div></div></div></div>",
    "<div class='gameCard'><div class='banner'><img src='./assets/banners/bookBanner.png'></div><div class='gameCard-content-container'><div class='gameCard-content'><div class='gameCard-tags-container'><div class='gameCard-tag memoria'><span>Memoria</span></div><span>Ensino Médio</span></div><div class='gameCard-text'><h6>Os Lusíadas</h6><p>Revisão sobre o livro</p><span>Por: Marcia Souza</span></div><div class='gameCard-info-container'><div><img src='./assets/icons/gameCard/playPurpleIcon.svg' alt='Icone de play'><span>8</span></div><div><button onclick='add()'><img src='./assets/icons/gameCard/saveLineIcon.svg' alt='Icone de salvar'></button><span>2</span></div></div><div><a href='./gameStart.html'><button class='gameCard-play fullColorLP'>Jogar agora</button></a></div></div></div></div>",
    "<div class='gameCard'><div class='banner'><img src='./assets/banners/mathBanner.png'></div><div class='gameCard-content-container'><div class='gameCard-content'><div class='gameCard-tags-container'><div class='gameCard-tag versus'><span>Versus</span></div><span>8-9 anos</span></div><div class='gameCard-text'><h6>Multiplicação simples</h6><p>Ajudando a decorar a tabuada</p><span>Por: Luciano Alves</span></div><div class='gameCard-info-container'><div><img src='./assets/icons/gameCard/playPurpleIcon.svg' alt='Icone de play'><span>8</span></div><div><button onclick='add()'><img src='./assets/icons/gameCard/saveLineIcon.svg' alt='Icone de salvar'></button><span>2</span></div></div><div><a href='./gameStart.html'><button class='gameCard-play fullColorLP'>Jogar agora</button></a></div></div></div></div>"
];
